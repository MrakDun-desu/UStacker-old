...
namespace FishNet.Authenticating
{
    ...
    ///     When checking to authenticate on the client side call AuthenticateAsHost, and if returned true skip normal
    ///     authentication.
    /// </summary>
    public abstract class HostAuthenticator : Authenticator
    {
        ...
        {
            var length = obj.ConnectionState == LocalConnectionState.Started ? 25 : 0;
            SetHostHash(length);
        }
        ...
        private void OnHostPasswordBroadcast(NetworkConnection conn, HostPasswordBroadcast hpb)
        {
            ...
            var correctPassword = hpb.Password == _hostHash;
        ...
        protected bool AuthenticateAsHost()
        {
            ...
            var hpb = new HostPasswordBroadcast
            {
                Password = _hostHash
            };
        ...
        /// </summary>
        [Tooltip("True to enable use of AuthenticateAsHost.")] [SerializeField]
