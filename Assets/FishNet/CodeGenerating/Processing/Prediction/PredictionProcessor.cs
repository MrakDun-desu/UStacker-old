...
namespace FishNet.CodeGenerating.Processing
{
    internal class PredictionProcessor : CodegenBase
    {
            ...
            CreatedPredictionFields predictionFields)
        {
            ...
            //Get clear method.
            var lstClearMr = gh.List_Clear_MethodRef.MakeHostInstanceGeneric(Session, dataListGit);
            var queueClearMr = gh.Queue_Clear_MethodRef.MakeHostInstanceGeneric(Session, dataQueueGit);
