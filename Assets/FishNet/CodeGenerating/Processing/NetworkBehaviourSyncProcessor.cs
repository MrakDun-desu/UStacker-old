...
namespace FishNet.CodeGenerating.Processing
{
    internal class NetworkBehaviourSyncProcessor : CodegenBase
    {
            ...
            FieldDefinition originalFd, CustomAttribute attribute, CreatedSyncVar createdSyncVar)
        {
            ...
            var sendRate = attribute.GetField(SENDRATE_NAME, -1f);
            var writePermissions = WritePermission.ServerOnly;
            var readPermissions = attribute.GetField(READPERMISSIONS_NAME, ReadPermission.Observers);
            ...
            do
            {
                ...
                if (copyTd.BaseType != null && copyTd.BaseType.FullName != GetClass<NetworkBehaviourHelper>().FullName)
                {
                    ...
                    if (!_baseCalledReadSyncVars.Contains(callerMd) && readMd != null && callerMd != null)
                    {
                        ...
                        var asServerPd = callerMd.Parameters[2];
            ...
            FieldDefinition originalFieldDef, MethodReference accessorSetMethodRef)
        {
            ...
            if (readSyncMethodDef == null)
            {
                ...
                GetClass<GeneralHelper>().CreateParameter(readSyncMethodDef, typeof(bool));
            ...
            var pooledReaderPd = readSyncMethodDef.Parameters[0];
            var indexPd = readSyncMethodDef.Parameters[1];
            var asServerPd = readSyncMethodDef.Parameters[2];
            ...
            var nextLastReadInstruction = processor.Create(OpCodes.Ldarg, indexPd);
            ...
            readInsts = GetClass<ReaderProcessor>().CreateRead(readSyncMethodDef, pooledReaderPd,
