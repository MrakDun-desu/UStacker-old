...
namespace FishNet.Managing.Scened
{
    ...
    public class SceneUnloadData
    {
        ...
        public SceneUnloadData(Scene scene) : this(new[] {scene})
        {
        }
        ...
        public SceneUnloadData(string sceneName) : this(new[] {sceneName})
        {
        }
        ...
        public SceneUnloadData(int sceneHandle) : this(new[] {sceneHandle})
        {
        }
