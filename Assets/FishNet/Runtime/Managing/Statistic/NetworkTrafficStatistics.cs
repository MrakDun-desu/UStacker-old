    ...
    public class NetworkTraficStatistics
    {
        ...
        private void TimeManager_OnPreTick()
        {
            ...
            if (UpdateServer && _networkManager.IsServer)
                OnServerNetworkTraffic?.Invoke(new NetworkTrafficArgs(_server_fromClientsBytes,
                    _server_toClientsBytes));
        ...
        /// </summary>
        [Tooltip("How often to update traffic statistics.")] [SerializeField] [Range(0f, 10f)]
        private float _updateInteval = 1f;

        /// <summary>
        /// </summary>
        [Tooltip("True to update client statistics.")] [SerializeField]
        ...
        /// <summary>
        /// </summary>
        [Tooltip("True to update server statistics.")] [SerializeField]
