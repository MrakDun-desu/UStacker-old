...
{
    /// <summary>
    ///     When this observer condition is placed on an object, a client must be within the specified distance to view the
    ///     object.
    /// </summary>
    ...
    public class DistanceCondition : ObserverCondition
    {
        ...
        /// </summary>
        private readonly Dictionary<NetworkConnection, float> _timedUpdates = new();
        ...
        /// <summary>
        ///     Additional percent of distance client must be until this object is hidden. For example, if distance was 100f and
        ///     percent was 0.5f the client must be 150f units away before this object is hidden again. This can be useful for
        ///     keeping objects from regularly appearing and disappearing.
        /// </summary>
        [Tooltip(
        ...
        /// <summary>
        ///     How often this condition may change for a connection. This prevents objects from appearing and disappearing
        ///     rapidly. A value of 0f will cause the object the update quickly as possible while any other value will be used as a
        ///     delay.
        /// </summary>
