...
namespace FishNet.Component.Animating
{
    ...
    public sealed class NetworkAnimator : NetworkBehaviour
    {
        ...
        private void TimeManager_OnPreTick()
        {
            ...
            var rd = _fromServerBuffer.Dequeue();
            var segment = rd.GetArraySegment();
        ...
        /// <summary>
        ///     Sets which animator to use. You must call this with the appropriate animator on all clients and server. This change
        ...
        /// <summary>
        ///     Sets which controller to use. You must call this with the appropriate controller on all clients and server. This
        ///     change is not automatically synchronized.
        /// </summary>
            ...
            if (ClientAuthoritative)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (_clientAuthoritativeUpdates.BufferCount == 0) return;
        ...
        private bool AnimatorUpdated(out ArraySegment<byte> updatedBytes, bool forceAll = false)
        {
            ...
            //Nothing to update.
            if (_writer.Position == 0) return false;
                        ...
                        else
                        {
                            ...
                            else if (acpt == AnimatorControllerParameterType.Float)
                            {
                                ...
                                if (_canSmoothFloats)
                                {
                                    ...
                                    var past = (float) TimeManager.TickDelta;
        ...
        private struct StateChange
        {
            ...
            ///     True if a crossfade.
            /// </summary>
            public readonly bool IsCrossfade;
            ...
            /// </summary>
            public readonly bool FixedTime;
            ...
            /// </summary>
            public readonly float NormalizedTransitionTime;
        ...
        private class ClientAuthoritativeUpdate
        {
            ...
            ///     Length of buffers.
            /// </summary>
            private readonly int[] _bufferLengths;
        ...
        {
            public readonly byte ParameterIndex;
        ...
        private class ParameterDetail
        {
            ...
            /// <summary>
            ///     Index within the types collection for this parameters value. The exception is with triggers; if the parameter type
            ///     is a trigger then a value of 1 is set, 0 is unset.
            /// </summary>
        ...
        /// </summary>
        [Tooltip("How many ticks to interpolate.")] [Range(1, NetworkTransform.MAX_INTERPOLATION)] [SerializeField]
        ...
        /// <summary>
        ///     True to synchronize server results back to owner. Typically used when you are changing animations on the server and
        ///     are relying on the server response to update the clients animations.
        /// </summary>
        [Tooltip(
        ...
        /// </summary>
        private readonly List<byte[]> _toClientsBuffer = new();
        ...
        /// </summary>
        private readonly Dictionary<int, SmoothedFloat> _smoothedFloats = new();
        ...
        /// </summary>
        private readonly Dictionary<int, StateChange> _unsynchronizedLayerStates = new();
        ...
        /// </summary>
        private readonly Queue<ReceivedServerData> _fromServerBuffer = new();
        ...
        private void ServerDataReceived(ref ArraySegment<byte> data)
        {
            ...
            if (IsOwner)
            {
                ...
                if (!ClientAuthoritative && !_sendToOwner)
                    return;
            }

            var rd = new ReceivedServerData(data);
