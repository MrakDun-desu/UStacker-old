...
namespace FishNet.Component.Ownership
{
    ...
    public class PredictedSpawn : NetworkBehaviour
    {
        ...
        [Tooltip("True to allow clients to predicted spawn this object.")] [SerializeField]
        ...
        [Tooltip("True to allow clients to predicted despawn this object.")] [SerializeField]
