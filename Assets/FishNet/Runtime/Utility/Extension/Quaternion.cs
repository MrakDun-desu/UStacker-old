...
namespace FishNet.Utility.Extension
{
    ...
    public static class QuaternionFN
    {
        ...
        /// </summary>
        /// <param name="precise">
        ///     True to use a custom implementation with no error tolerance. False to use Unity's implementation
        ///     which may return a match even when not true due to error tolerance.
        /// </param>
        /// <returns></returns>
        ...
        /// <param name="precise">
        ///     True to use a custom implementation with no error tolerance. False to use Unity's implementation
        ///     which may return 0f due to error tolerance, even while there is a difference.
        /// </param>
        /// <returns></returns>
