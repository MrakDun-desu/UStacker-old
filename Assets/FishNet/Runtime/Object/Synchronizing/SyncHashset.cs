...
namespace FishNet.Object.Synchronizing
{
    public class SyncHashSet<T> : SyncBase, ISet<T>
    {
        ...
        public override void WriteDelta(PooledWriter writer, bool resetSyncTick = true)
        {
            ...
            else
            {
                ...
                for (var i = 0; i < _changed.Count; i++)
                {
                    ...
                    if (change.Operation == SyncHashSetOperation.Add ||
                        change.Operation == SyncHashSetOperation.Remove ||
                        change.Operation == SyncHashSetOperation.Update) writer.Write(change.Item);
                }
        ...
        /// </summary>
        private readonly ISet<T> _initialValues = new HashSet<T>();
