...
namespace FishNet.Object.Synchronizing
{
    public class SyncIDictionary<TKey, TValue> : SyncBase, IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        /// </summary>
        /// <param name="asServer">
        ///     True if returning the server value, false if client value. The values will only differ when
        ///     running as host. While asServer is true the most current values on server will be returned, and while false the
        ///     latest values received by client will be returned.
        /// </param>
        ...
        public override void Read(PooledReader reader, bool asServer)
        {
            ...
            * and potentially overwrite data not yet sent. */
            ...
            var fullWrite = reader.ReadBoolean();
            if (fullWrite)
                collection.Clear();
        ...
        public void Dirty(TKey key)
        {
            ...
            if (Collection.TryGetValueIL2CPP(key, out var value))
                AddOperation(SyncDictionaryOperation.Set, key, value);
        }
        ...
        /// </summary>
        private readonly IDictionary<TKey, TValue> _initialValues = new Dictionary<TKey, TValue>();
        ...
        ///     The only reasonable way to reset this during a Reset call is by duplicating the original list and setting all
        ///     values to it on reset.
        /// </summary>
