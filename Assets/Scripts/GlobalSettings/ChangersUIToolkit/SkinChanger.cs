...
{
    public class SkinChanger : BsDropdownField, INotifyOnChange
    {
        public new class UxmlTraits : BsDropdownField.UxmlTraits
        {
        }

        public new class UxmlFactory : UxmlFactory<SkinChanger, UxmlTraits>
        {
        }
        ...
        public SkinChanger() : this(string.Empty)
        {
        }
        
        public SkinChanger(string settingPath)
        {
